...
rotaryEncoder::rotaryEncoder(encoderListener * listener, const int posCounter, const bool swPress): 
...
void rotaryEncoder::setPos(const int newPos){
	posCounter = newPos;
}
...
bool rotaryEncoder::testCorrectFunctioning(){
